...
export default function SponsorEdit({ runpart, sponsor }: Props) {
    ...
    const deleteSponsor = () => {
        if (confirm(t('common.confirm_delete'))) {
            router.delete(route('runpart.sponsor.destroy', [runpart.id, sponsor.id]));
        }
    };
    ...
    return (
        <AppLayout>
            ...
            <form
                onSubmit={(e) => {
                    e.preventDefault();
                    patch(route('runpart.sponsor.update', [runpart.id, sponsor.id]));
                }}
